...
<div style="background-image: url(images/bg/new-background.jpg);background-size: cover;height: 100%;position: relative;top: 0;background-position: center center !important;z-index: 1;width: 100%;background-repeat: no-repeat;">
