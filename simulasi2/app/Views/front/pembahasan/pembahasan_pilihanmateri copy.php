                            ...
                            <div class="bg-gray col-md-8 text-center" style="top: 50%;left: 50%;transform: translate(-50%, -50%);height: 300px;">
                                ...
                                <?php
                                    if ($group[0]->group_soal_id == 4) {
                                        echo "<a href='".base_url()."/pembahasan/sikapkerja/".$materi_id[0]."/".$group[0]->group_soal_id."' class='btn btn-success' style='font-size:18px;'>Mulai</a>";
                                    } else {
                                        echo "<a href='".base_url()."/pembahasan/ujian/".$materi_id[0]."/".$group[0]->group_soal_id."' class='btn btn-success' style='font-size:18px;'>Mulai</a>";
                                    }
                                ?>
                            </div>
                        </div>
