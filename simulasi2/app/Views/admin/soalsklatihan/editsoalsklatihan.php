...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Soal Sikap Kerja (Latihan)</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url() ?>">Home</a></li>
              <li class="breadcrumb-item active">Edit Soal Sikap Kerja (Latihan)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    ...
    function updateImage(input, number, pilihan) {
        ...
        $.ajax({
            url: "<?= base_url('admin/soalsikapkerjalatihan/updateGambarSk') ?>",
            type: "post",
            dataType: "json",
            data: formData,
            cache: false,
