                            ...
                            <div class="row col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="group_id" id="group_id" class="form-control" onchange="getNoSoal()">
                                            ...
                                            <option value="<?= $key->group_soal_id  ?>"
                                                <?= ($keySoal->group_id  == $key->group_soal_id ?"selected":"") ?>>
                                                <?= $key->group_nm ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div id="dv_soalimg_<?= $keySoal->soal_id ?>">
                                            <img src="<?= base_url() ?>/images/soal/materi/<?= $keySoal->materi ?>/<?= $keySoal->soal_img ?>" alt="" width="200" height="200">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    ?>
                                    <div id="dv_soalimg_<?= $keySoal->soal_id ?>">
                                        <img src="<?= base_url() ?>/images/pembahasan/<?= $keySoal->materi ?>/<?= $keySoal->pembahasan_img ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-8">
                                                    <div class="col-sm-6"><label>Jawaban A</label></div>
                                                        <div class="card card-outline card-info">
                                                            <div class="card-body">
                                                                <input type="hidden" value="<?= $jawaban[0]->pilihan_nm == "A" && !empty($jawaban[0]) ? $jawaban[0]->jawaban_id : "" ?>" id="jawaban_id_A"/>
                                                                <textarea class="form-control summernote" id="jawaban_nm_A" name="jawaban_nm_A"><?= $jawaban[0]->pilihan_nm == "A" && $jawaban[0]->jawaban_nm != NULL ? $jawaban[0]->jawaban_nm : "" ?></textarea>
                                                            </div>
                                                        </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= $jawaban[1]->jawaban_id ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= $jawaban[0]->materi ?>/<?= $jawaban[0]->jawaban_img ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-8">
                                                    <div class="col-sm-6"><label>Jawaban B</label></div>
                                                        <div class="card card-outline card-info">
                                                            <div class="card-body">
                                                                <input type="hidden" value="<?= $jawaban[1]->pilihan_nm == "B" && !empty($jawaban[1]) ? $jawaban[1]->jawaban_id : "" ?>" id="jawaban_id_B"/>
                                                                <textarea class="form-control summernote" id="jawaban_nm_B" name="jawaban_nm_B"><?= $jawaban[1]->pilihan_nm == "B" && $jawaban[1]->jawaban_nm != NULL ? $jawaban[1]->jawaban_nm : "" ?></textarea>
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= $jawaban[1]->jawaban_id ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= $jawaban[1]->materi ?>/<?= $jawaban[1]->jawaban_img ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-8">
                                                    <div class="col-sm-6"><label>Jawaban C</label></div>
                                                        <div class="card card-outline card-info">
                                                            <div class="card-body">
                                                                <input type="hidden" value="<?= isset($jawaban[2]) ? $jawaban[2]->pilihan_nm == "C" && !empty($jawaban[2]) ? $jawaban[2]->jawaban_id : "" : "" ?>" id="jawaban_id_C"/>
                                                                <textarea class="form-control summernote" id="jawaban_nm_C" name="jawaban_nm_C"><?= isset($jawaban[2]) ? $jawaban[2]->pilihan_nm == "C" && $jawaban[2]->jawaban_nm != NULL ? $jawaban[2]->jawaban_nm : "" : "" ?></textarea>
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[2]) ? $jawaban[2]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[2]->materi) ? $jawaban[2]->materi : '' ?>/<?= isset($jawaban[2]->jawaban_img) ? $jawaban[2]->jawaban_img : '' ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-8">
                                                    <div class="col-sm-6"><label>Jawaban D</label></div>
                                                        <div class="card card-outline card-info">
                                                            <div class="card-body">
                                                                <input type="hidden" value="<?= isset($jawaban[3]) ? ($jawaban[3]->pilihan_nm == "D" && !empty($jawaban[3]) ? $jawaban[3]->jawaban_id : "") : '' ?>" id="jawaban_id_D"/>
                                                                <textarea class="form-control summernote" id="jawaban_nm_D" name="jawaban_nm_D"><?= isset($jawaban[3]) ? ($jawaban[3]->pilihan_nm == "D" && $jawaban[3]->jawaban_nm != NULL ? $jawaban[3]->jawaban_nm : "") : '' ?></textarea>
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[3]->jawaban_id) ? $jawaban[3]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[3]->materi) ? $jawaban[3]->materi : '' ?>/<?= isset($jawaban[3]->jawaban_img) ? $jawaban[3]->jawaban_img : '' ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-8">
                                                    <div class="col-sm-6"><label>Jawaban E</label></div>
                                                        <div class="card card-outline card-info">
                                                            <div class="card-body">
                                                                <input type="hidden" value="<?= isset($jawaban[4]) ? ($jawaban[4]->pilihan_nm == "E" && !empty($jawaban[4]) ? $jawaban[4]->jawaban_id : "") : '' ?>" id="jawaban_id_E"/>
                                                                <textarea class="form-control summernote" id="jawaban_nm_E" name="jawaban_nm_E"><?= isset($jawaban[4]) ? ($jawaban[4]->pilihan_nm == "E" && $jawaban[4]->jawaban_nm != NULL ? $jawaban[4]->jawaban_nm : "") : '' ?></textarea>
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[4]->jawaban_id) ? $jawaban[4]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[4]->materi) ? $jawaban[4]->materi : '' ?>/<?= isset($jawaban[4]->jawaban_img) ? $jawaban[4]->jawaban_img : '' ?>" alt="" width="200" height="200">
...
<script>
    function hapusgambar(jawaban_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url('admin/soal/hapusgambar') ?>",
                    type: "post",
                    dataType: "json",
                    data: {
    ...
    function hapusgambarsoal(soal_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url('admin/soal/hapusgambarsoal') ?>",
                    type: "post",
                    dataType: "json",
                    data: {
                        "soal_id": soal_id
    ...
    function hapusgambarpembsoal(soal_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url('admin/soal/hapusgambarpembsoal') ?>",
                    type: "post",
                    dataType: "json",
                    data: {
                        "soal_id": soal_id
    ...
    function getNoSoal() {
        ...
        $.ajax({
            url: "<?= base_url('admin/soal/getNoSoal') ?>",
            type: "post",
            dataType: "json",
            data: {
                "materi_id": materi_id,
                ...
                success: function(data) {
                    ...
                    if (data.respon == "berhasil") {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = "<?= base_url() ?>/admin/soal/viewEditsoal/"+data.soal_id+"/"+data.no_soal+"/"+group_id+"/"+materi_id;
                            }
                        });
