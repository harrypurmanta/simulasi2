...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Soal Sikap Kerja (Latihan)</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url() ?>">Home</a></li>
              <li class="breadcrumb-item active">Tambah Soal Sikap Kerja (Latihan)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                            ...
                            <div class="row align-items-center">
                                <div class="col-2">
                                    <div class="form-group mb-0 ml-5">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="typesoal" value="text" onclick="changeTypeSoal('text')">
                                                Teks
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="typesoal" value="gambar" checked onclick="changeTypeSoal('gambar')">
                                                Gambar
                                            </label>
                                        </div>
                                    </div>
...
<script>
    ...
    function simpanImage(input, number, pilihan) {
        ...
        $.ajax({
            url: "<?= base_url('admin/soalsikapkerjalatihan/upsertGambarSk') ?>",
            type: "post",
            dataType: "json",
            data: formData,
            cache: false,
