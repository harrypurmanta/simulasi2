...
<script>
  ...
  tampilkansoal = () => {
    ...
    $("#tbl_soal").DataTable({
        ajax: {
            url: "/admin/soalsikapkerjamateri/showkolom",
            type: "POST",
            data: function(d) {
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                  if (data.clue == null) {
                    return `
                        <a href="<?= base_url() ?>/admin/soalsikapkerjamateri/tambahsoalSkMateri/${data.kolom_id}/4/${materi_id}/0" type="button" class="btn btn-sm btn-success"><i class="fas fa-plus"></i></a>`;
                  }

                  if (data.kolom_id != null) {
                    return `
                        <a href="<?= base_url() ?>/admin/soalsikapkerjamateri/detailsoal/${data.kolom_id}" type="button" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                        <a href="<?= base_url() ?>/admin/soalsikapkerjamateri/viewEditsoalSkMateri/${data.kolom_id}/4/${materi_id}/0" type="button" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>`;
                  }
